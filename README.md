...
Read about attributes in [swagger-php attributes](http://zircote.com/swagger-php/reference/attributes.html) topic.

But maybe you can learn better by [examples](https://zircote.github.io/swagger-php/guide/examples.html).

# Model for API page

The following page shows the documentation generated by this component. You only need to replace [WEB ROOT ROUTE] by the root URL of your application.

For example, for a Laminas/Mezzio PHP application, [WEB ROOT ROUTE] is `<?=$this->url('home')?>`.
